...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "accountManagerActionLine2":
            MessageLookupByLibrary.simpleMessage("备份keyStore"),
        "accountManagerActionLine3":
            MessageLookupByLibrary.simpleMessage("备份私钥"),
        ...
        "accountManagerSnackBar":
            MessageLookupByLibrary.simpleMessage("地址复制成功"),
        ...
        "appMainContainerNavBarWallet":
            MessageLookupByLibrary.simpleMessage("钱包"),
        "appMainContainerOutdateBtn":
            MessageLookupByLibrary.simpleMessage("去更新"),
        "appMainContainerOutdateText":
            MessageLookupByLibrary.simpleMessage("必须更新才能继续使用本软件"),
        "backupAccountCopy": MessageLookupByLibrary.simpleMessage("复制"),
        "backupAccountDescKeystore": MessageLookupByLibrary.simpleMessage(
            "Keystore文件是加密后的私钥，请复制并妥善保存在安全的地方，一旦丢失，无法找回。以下是钱包的Keystore文件。"),
        ...
        "backupMnemonicSafeAreaConfirm":
            MessageLookupByLibrary.simpleMessage("我已抄写完毕"),
        "backupMnemonicSafeAreaInfo1":
            MessageLookupByLibrary.simpleMessage("• 助记词即是私钥，由12~24个单词组成"),
        "backupMnemonicSafeAreaInfo2":
            MessageLookupByLibrary.simpleMessage("• 你可以通过助记词恢复你的资产"),
        "backupMnemonicSafeAreaInfo3":
            MessageLookupByLibrary.simpleMessage("• 为了你的资产安全，请务必在抄写并存放至安全位置"),
        "backupMnemonicSafeAreaInfo4":
            MessageLookupByLibrary.simpleMessage("• 助记词一旦丢失，不可找回"),
        "backupMnemonicSafeAreaText1":
            MessageLookupByLibrary.simpleMessage("请按照顺序正确抄写并存放至安全位置"),
        "configTermsUrl": MessageLookupByLibrary.simpleMessage(
        ...
        "createWalletConfirmHelperText":
            MessageLookupByLibrary.simpleMessage("再次输入密码以确认"),
        ...
        "createWalletHelperText":
            MessageLookupByLibrary.simpleMessage("不少于8位字符，建议混合大小写字母，数字，符号"),
        ...
        "createWalletInfoLine1":
            MessageLookupByLibrary.simpleMessage("• 密码用于加密保护私钥、转账等，请设置高强度密码。 "),
        "createWalletInfoLine2": MessageLookupByLibrary.simpleMessage(
            "• RUFF不存储密码，也无法帮您找回密码，请务必牢记。"),
        ...
        "importWalletConfirmHelper":
            MessageLookupByLibrary.simpleMessage("再次输入密码以确认"),
        "importWalletConfirmText": MessageLookupByLibrary.simpleMessage("确认密码"),
        "importWalletFormHelper":
            MessageLookupByLibrary.simpleMessage("请输入助记词，按空格分隔"),
        "importWalletFormKeystoreHelper":
            MessageLookupByLibrary.simpleMessage("请输入Keystore内容"),
        "importWalletFormKeystoreLabel":
            MessageLookupByLibrary.simpleMessage("Keystore"),
        "importWalletFormKeystorePasswordHelper":
            MessageLookupByLibrary.simpleMessage("keystore密码会作为钱包密码"),
        "importWalletFormKeystorePasswordLabel":
            MessageLookupByLibrary.simpleMessage("keystore密码"),
        "importWalletFormLabel": MessageLookupByLibrary.simpleMessage("助记词"),
        "importWalletFormPasswordHelper":
            MessageLookupByLibrary.simpleMessage("不少于8位字符，建议混合大小写字母，数字，符号"),
        ...
        "importWalletImportKeystore": MessageLookupByLibrary.simpleMessage(
            "密码无法解开Keystore,请正确输入密码和keystore内容"),
        "importWalletImportMnemonic":
            MessageLookupByLibrary.simpleMessage("无效的助记词"),
        "importWalletImportPrivatekey":
            MessageLookupByLibrary.simpleMessage("无效的私钥"),
        "importWalletKeystore":
            MessageLookupByLibrary.simpleMessage("请输入Keystore"),
        ...
        "importWalletValidPwdEqual":
            MessageLookupByLibrary.simpleMessage("密码不一致"),
        "importWalletValidPwdLength":
            MessageLookupByLibrary.simpleMessage("不少于8位字符，建议混合大小写字母，数字，符号"),
        "importWalletValidate":
            MessageLookupByLibrary.simpleMessage("钱包已存在，无需重复导入"),
        ...
        "mineAboutSafeAreaVersionLog":
            MessageLookupByLibrary.simpleMessage("版本日志"),
        ...
        "mineVersion120":
            MessageLookupByLibrary.simpleMessage("修复：转账金额小数点后位数过多时失败的问题"),
        "mineVersion121": MessageLookupByLibrary.simpleMessage("修复：地址有效性验证的问题"),
        "mineVersion122":
            MessageLookupByLibrary.simpleMessage("修复: English 版本"),
        ...
        "termsAgreeConfirm":
            MessageLookupByLibrary.simpleMessage("我已仔细阅读并同意以上协议"),
        ...
        "transferTokenConfirmModalContent":
            MessageLookupByLibrary.simpleMessage("交易成功! Hash值："),
        "transferTokenConfirmModalTitle":
            MessageLookupByLibrary.simpleMessage("交易已确认"),
        "transferTokenEnter": MessageLookupByLibrary.simpleMessage("请输入"),
        "transferTokenEnterAmount":
            MessageLookupByLibrary.simpleMessage("请输入数量"),
        "transferTokenEnterValid":
            MessageLookupByLibrary.simpleMessage("请输入有效的数字"),
        "transferTokenErrGasfee":
            MessageLookupByLibrary.simpleMessage("请输入≥0.1的Gasfee"),
        "transferTokenErrPrecision":
            MessageLookupByLibrary.simpleMessage("Token精度输入最多9位"),
        "transferTokenFormAddressHelper":
            MessageLookupByLibrary.simpleMessage("请输入收款地址 "),
        "transferTokenFormAddressLabel":
            MessageLookupByLibrary.simpleMessage("收款地址 "),
        "transferTokenFormGasHelper":
            MessageLookupByLibrary.simpleMessage("请输入 ≥ 0.1的矿工费用"),
        "transferTokenFormTokenHelper":
            MessageLookupByLibrary.simpleMessage("请输入转账数量"),
        "transferTokenFormTokenLabel":
            MessageLookupByLibrary.simpleMessage("Token 数量 "),
        "transferTokenInvalidAddr":
            MessageLookupByLibrary.simpleMessage("收款地址无效，请重新输入"),
        "transferTokenScanAccessErr":
            MessageLookupByLibrary.simpleMessage("相机访问出错"),
        "transferTokenScanDenied": MessageLookupByLibrary.simpleMessage(
            "请在手机设置中开启应用的相机权限，才能正常使用扫码功能。"),
        ...
        "txHistoryListTitle":
            MessageLookupByLibrary.simpleMessage("网络不稳定，请重新再试"),
